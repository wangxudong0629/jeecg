package com.jeecg.crrc.planforplus.entity;
 ...
 */
@Entity
@Table(name = "plan_for_plus_child", schema = "")
@SuppressWarnings("serial")
public class PlanForPlusChildEntity implements java.io.Serializable {
	/**主键*/
