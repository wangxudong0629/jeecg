package com.jeecg.crrc.tabletestb.service.impl;
...
@Service("tabletestBService")
@Transactional
public class TabletestBServiceImpl extends CommonServiceImpl implements TabletestBServiceI {
