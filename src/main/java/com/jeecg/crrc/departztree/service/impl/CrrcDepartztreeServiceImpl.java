package com.jeecg.crrc.departztree.service.impl;
...
@Service("crrcDepartztreeService")
@Transactional
public class CrrcDepartztreeServiceImpl extends CommonServiceImpl implements CrrcDepartztreeServiceI {
