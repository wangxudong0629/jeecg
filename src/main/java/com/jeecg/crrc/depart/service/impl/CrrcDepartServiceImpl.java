package com.jeecg.crrc.depart.service.impl;
...
@Service("crrcDepartService")
@Transactional
public class CrrcDepartServiceImpl extends CommonServiceImpl implements CrrcDepartServiceI {
