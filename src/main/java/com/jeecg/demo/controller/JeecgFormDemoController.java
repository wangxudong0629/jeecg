...
//     * @return
//     */
//    @RequestMapping(params="getPlanTree",method ={RequestMethod.GET, RequestMethod.POST})
//    @ResponseBody
//    public AjaxJson getPlanTree(PlanEntity plan, HttpServletResponse response, HttpServletRequest request ){
//        AjaxJson j = new AjaxJson();
//        try{
...
//            List<Map<String,Object>> dataList = new ArrayList<Map<String,Object>>();
//            Map<String,Object> map = null;
//            for (PlanEntity plasent : planList) {
//                String sqls = null;
//                Object[] paramss = null;
//                map = new HashMap<String,Object>();
//                map.put("id", plasent.getId());
//                map.put("name", plasent.getPname());
//                if (plasent.getpn()!= null) {
//                    map.put("pId", plasent.getpn().getId());
//                    map.put("open",false);
//                }else {
//                    map.put("pId", "1");
//                    map.put("open",false);
//                }
//                sqls = "select count(1) from plan t where t.number = ?";
//                paramss = new Object[]{plasent.getId()};
//                long counts = this.systemService.getCountForJdbcParam(sqls, paramss);
//                if(counts>0){
//                    dataList.add(map);
//                }else{
//                    PlanEntity de = this.systemService.get(PlanEntity.class, plasent.getId());
//                    if (de != null) {
//                        map.put("id", de.getId());
...
//    }
	...
	public ModelAndView ztreeDemo(HttpServletRequest request) {
		return new ModelAndView("system/jeecg/demo/ztreeDemo");
	}
