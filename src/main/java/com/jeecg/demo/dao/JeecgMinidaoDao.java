...
public interface JeecgMinidaoDao {
	...
	@ResultType(CrrcUserEntity.class)
	public MiniDaoPage<CrrcUserEntity> getAllEntities(@Param("CrrcUser") CrrcUserEntity CrrcUser, @Param("page")  int page, @Param("rows") int rows,@Param("sort")String sort, @Param("order")String order,@Param("authSql") String authSql);
