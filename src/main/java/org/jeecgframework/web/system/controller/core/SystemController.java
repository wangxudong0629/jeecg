...
//	 * @return
//	 */
//	@RequestMapping(params = "savePlan")
//	@ResponseBody
//	public AjaxJson savePlan(PlanEntity plan, HttpServletRequest request) {
//		String message = null;
//		// 设置上级部门
//		String pid = request.getParameter("PlanEntity.id");
//		if (pid.equals("")) {
//			plan.setPlanEntity(null);
//		}
//		AjaxJson j = new AjaxJson();
//		if (StringUtil.isNotEmpty(plan.getId())) {
//			userService.saveOrUpdate(plan);
//			message = MutiLangUtil.paramUpdSuccess("common.department");
//			systemService.addLog(message, Globals.Log_Type_UPDATE, Globals.Log_Leavel_INFO);
//
//		} else {
...
////			depart.setOrgCode(orgCode);
//			if(oConvertUtils.isNotEmpty(pid)){
//				PlanEntity paretDept = systemService.findUniqueByProperty(PlanEntity.class, "id", pid);
//				String localMaxCode  = getMaxLocalCode(paretDept.getNumber());
//				plan.setNumber(YouBianCodeUtil.getSubYouBianCode(paretDept.getNumber(), localMaxCode));
//			}else{
//				String localMaxCode  = getMaxLocalCode(null);
//				plan.setNumber(YouBianCodeUtil.getNextYouBianCode(localMaxCode));
//			}
//
//			userService.save(plan);
//			message = MutiLangUtil.paramAddSuccess("common.planment");
//			systemService.addLog(message, Globals.Log_Type_INSERT, Globals.Log_Leavel_INFO);
//
//		}
//		j.setMsg(message);
