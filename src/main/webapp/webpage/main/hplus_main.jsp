...
<head>
    ...
    <title>CRRC</title>
    <meta name="keywords" content="CRRC">
    <meta name="description" content="CRRC">
...
<body class="fixed-sidebar full-height-layout pace-done gray-bg mini-navbar" style="overflow:hidden">
<div id="wrapper">
    <!--左侧导航开始-->
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="欢迎使用CRRC智慧平台" class="form-control" name="top-search" id="top-search"readonly>
                        </div>
                    </form>
                </div>
        ...
        <div class="row J_mainContent" id="content-main" style="margin-left:-13px;width: 102%;height: 90%;">
