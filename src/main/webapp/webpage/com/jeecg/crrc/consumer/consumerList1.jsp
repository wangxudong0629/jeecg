...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="consumerList" checkbox="false" pagination="true" fitColumns="true" title="客户表" sortName="id" actionUrl="consumerController.do?datagrid&planId=${plan}" idField="id" fit="true" queryMode="group">
