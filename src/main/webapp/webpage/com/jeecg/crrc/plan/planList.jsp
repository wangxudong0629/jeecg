...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="planList" checkbox="false" pagination="true" treegrid="true" treeField="pname" fitColumns="true" title="项目管理" actionUrl="planController.do?datagrid" idField="id" sortName="createDate" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="planController.do?goAdd1" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="planController.do?goUpdate1" funname="updatetree" width="100%" height="100%"></t:dgToolBar>
