                    ...
                    <div class="container">
                        <div class="div1" style="border:1px solid #C0C0C0;border-radius:5px 5px 5px 5px">
                            <div class="form">
                                ...
                                <input type="text"  name="pname" class="bule" readonly value="${plan.pname}"/>
                            </div>
                            <div class="form">
                                <label class="Validform_label">项目经理: </label>
                                <input type="text"  name="username" class="bule" readonly value="${plan.username}"/>
                            </div>
                            <div class="form">
                                <label class="Validform_label"> 项目开始时间: </label>
                                <input type="text"  name="stime" class="bule"readonly value="<fmt:formatDate value='${plan.dateby}' type="date" pattern="yyyy-MM-dd"/>"/>
                            </div>
                            <div class="form">
                                <label class="Validform_label"> 项目结束时间: </label>
                                <input type="text" name="etime" class="bule"readonly value="<fmt:formatDate value='${plan.dateend}' type="date" pattern="yyyy-MM-dd"/>"/>
                            </div>
                            <div class="form">
                                <label class="Validform_label">项目级别: </label>
                                <input type="text" name="mobile" class="bule"readonly value="${plan.level}"/>
                            </div>
                            <div class="form">
                                <label class="Validform_label">备注: </label>
                                <input type="text" name="fax" class="bule" readonly value="${plan.remarks}"/>
                            </div>
                            <div class="form">
                                <label class="Validform_label">进度: </label>
                                <input type="text" name="process" class="bule" readonly value="${plan.process}%"/>
                            </div>
                        </div>
                        <div class="div2" id="tu" style="border:1px solid #C0C0C0;border-radius:5px 5px 5px 5px">
                            <%--<div id="main" style="width: 100px"></div>--%>
                                <iframe name="roomFrame" src="planController.do?jQgantt&id=${plan.id}" width="100%" height="100%" frameborder="0"></iframe>
                        </div>
                    </div>
                </div>
                <div class="tab-content mainshowPlan hidepage">
                    <iframe name="roomFrame" src="planController.do?rng&id=${plan.id}" width="100%" height="650px" frameborder="0"></iframe>
                </div>
