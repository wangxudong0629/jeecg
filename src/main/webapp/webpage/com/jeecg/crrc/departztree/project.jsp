    ...
    <div class="dl-main-nav">
        <ul class="nav-list">
            <li class="nav-item dl-selected" id="showProject">
                <div class="nav-item-inner">组织详情</div>
                    ...
                    <div class="container">
                        <div class="div1" style="border:1px solid #C0C0C0;border-radius:5px 5px 5px 5px">
                            <div class="form">
                                ...
                                <input type="text"  name="dName" class="bule" readonly value="${depart1.getDName()}"/>
                            </div>
                            <div class="form">
                                <label class="Validform_label">组织电话: </label>
                                <input type="text"  name="username" class="bule" readonly value="${depart1.getDIphone()}"/>
                            </div>
                            <div class="form">
                                <label class="Validform_label">组织邮件: </label>
                                <input type="text" name="mobile" class="bule"readonly value="${depart1.getDEmail()}"/>
                            </div>
                            <div class="form">
                                <label class="Validform_label">备注: </label>
                                <input type="text" name="fax" class="bule" readonly value="${depart1.getDRemarks()}"/>
                            </div>
                    </div>
                </div>
