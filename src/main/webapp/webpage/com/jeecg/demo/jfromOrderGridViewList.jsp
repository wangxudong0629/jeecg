...
<div class="easyui-layout" fit="true">  
  ...
  <t:datagrid name="jfromOrderList" checkbox="true" fitColumns="true" complexSuperQuery="event"  title="订单列表" extendParams="view: detailview,detailFormatter:detailFormatterFun,onExpandRow: onExpandRowFun"
