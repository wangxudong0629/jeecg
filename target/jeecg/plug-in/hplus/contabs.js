...
//关闭之前打开的选项卡
        	...
        	if($(".J_iframe").length>10){
        		layer.open({
        			  ...
        			  ,type: 1
        			  ,content: '<div style="padding: 20px 1px 20px 60px;border-bottom:1px solid #ddd"><i style="position: absolute;top: 16px;left: 15px; width: 30px;height: 30px;" class="layui-layer-ico layui-layer-ico0"></i>请先刷新页面！</div>'
        			  ,btn: '确 定'
        			  ,icon:1
        			  ,btnAlign: 'c'
        			  ,area: ['330px', '160px']
