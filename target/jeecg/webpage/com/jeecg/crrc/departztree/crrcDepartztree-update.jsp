...
<head>
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="crrcDepartztreeController.do?doUpdate" tiptype="1" >
			<input type="hidden" id="btn_sub" class="btn_sub"/>
			<input type="hidden" name="id" value='${crrcDepartztreePage.id}' >
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>名称：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="deName" name="deName" maxlength="50" type="text" class="form-control" ignore="ignore"  value='${crrcDepartztreePage.deName}' />
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>类型：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="deType" name="deType" maxlength="50" type="text" class="form-control" ignore="ignore"  value='${crrcDepartztreePage.deType}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>预留1：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="deNotel1" name="deNotel1" maxlength="32" type="text" class="form-control" ignore="ignore"  value='${crrcDepartztreePage.deNotel1}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>预留2：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="deNotel2" name="deNotel2" maxlength="32" type="text" class="form-control" ignore="ignore"  value='${crrcDepartztreePage.deNotel2}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>预留3：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="deNotel3" name="deNotel3" maxlength="32" type="text" class="form-control" ignore="ignore"  value='${crrcDepartztreePage.deNotel3}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>预留4：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="deNotel4" name="deNotel4" maxlength="32" type="text" class="form-control" ignore="ignore"  value='${crrcDepartztreePage.deNotel4}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
