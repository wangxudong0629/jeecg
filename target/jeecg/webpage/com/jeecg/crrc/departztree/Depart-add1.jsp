	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="crrcDepartController.do?doAdd" tiptype="1" >
			...
			<div class="tab-wrapper">
			    ...
			    <ul class="nav nav-tabs">
			      <li role="presentation" class="active"><a href="javascript:void(0);">添加组织</a></li>
			    </ul>
			    <!-- tab内容 -->
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
					  ...
					  <div class="row show-grid"style="display: none">
						  ...
						  <div class="col-xs-3 form">
							  <label class="Validform_label" >父级</label>
							  <input id="dNumber" name="dNumber" maxlength="50" type="text" class="form-control"  ignore="ignore" value="${crrcDepartztree.id}"/>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
						  </div>
					  </div>
  ...
  function neibuClick() {
      ...
      $.ajax({
          ...
          data: {id:$("#id").val(), dName:$("#dName").val()
              , dIphone:$("#dIphone").val()
              , dEmail:$("#dEmail").val(), dRemarks:$("#dRemarks").val(),dNumber:$("#dNumber").val()},
