...
">
		...
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-9 col-sm-9 col-xs-9 bt-content">
					<%--<input name="uDepartid" id="uDepartid" type="text"class="form-control input-sm" maxlength="50"  ignore="ignore"  />--%>
		...
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				<div class="col-md-3 col-sm-3 col-xs-3 bt-label"s>
					人员等级：
				</div>
				<div class="col-md-9 col-sm-9 col-xs-9 bt-content">
		...
		<div class="bt-item col-md-6 col-sm-6"style="display: none">
			<div class="row">
				...
				<div class="col-md-9 col-sm-9 col-xs-9 bt-content">
					<input name="uDepartname" type="text" class="form-control input-sm" maxlength="50"  ignore="ignore"  />
				</div>
			</div>
		</div>
		<div class="bt-item col-md-6 col-sm-6"style="display: none">
...
$(function() {
    $('#uDepartid').combotree({
        url : 'crrcUserController.do?setPFunction',
        width: 330,
