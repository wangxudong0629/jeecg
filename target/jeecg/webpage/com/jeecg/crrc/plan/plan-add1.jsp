...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="planController.do?doAdd1"
tiptype="6" >
        ...
        <div class="con-wrapper" id="con-wrapper1" style="display: block;">
            <div class="row form-wrapper">
                <div class="row show-grid">
                    ...
                    <div class="col-xs-3">
                        <input id="pname" name="pname" maxlength="50" type="text" class="form-control"  datatype="*"  ignore="checked" />
                ...
                <div class="row show-grid">
                    ...
                    <div class="col-xs-3">
                        <input id="dateby" name="dateby" type="text" datatype="*"  ignore="checked" style="background: url('plug-in/ace/images/datetime.png') no-repeat scroll right center transparent;"  class="form-control" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                        <span class="Validform_checktip" style="float:left;height:0px;"></span>
                ...
                <div class="row show-grid">
                    ...
                    <div class="col-xs-3">
                        <input id="dateend" name="dateend" type="text" datatype="*"  ignore="checked" style="background: url('plug-in/ace/images/datetime.png') no-repeat scroll right center transparent;"  class="form-control" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                        <span class="Validform_checktip" style="float:left;height:0px;"></span>
                ...
                <div class="row show-grid">
                    ...
                    <div class="col-xs-3">
                        <input id="date" name="date" maxlength="32" type="text" class="form-control"  ignore="ignore" readonly/>
                        <span class="Validform_checktip" style="float:left;height:0px;"></span>
                ...
                <div class="row show-grid">
                    ...
                    <div class="col-xs-3">
                        <input id="level" name="level" maxlength="32" type="text" class="form-control"  datatype="*"  ignore="checked" />
                        <span class="Validform_checktip" style="float:left;height:0px;"></span>
