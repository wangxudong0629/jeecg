...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="papersList" checkbox="true" pagination="true" title="文件列表" fitColumns="true"  actionUrl="papersController.do?datagrid&prid=${plan.id}" idField="id" sortName="createDate" fit="true" queryMode="group">
