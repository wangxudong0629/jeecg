...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="papersList" checkbox="true" pagination="true" title="文件列表" fitColumns="true"  actionUrl="papersController.do?datagrid&prid=${plan.id}" idField="id" sortName="createDate" fit="true" queryMode="group" pageSize="4">
   ...
   <%--<t:dgFunOpt title="删除"  funname="neibuClick(id)" urlclass="ace_button"  urlfont="fa-trash-o" />--%>
...
function listFileImgFormat(value,type){
 ...
 <%--function neibuClick(id) {--%>
     <%--$.ajax({--%>
         <%--type: "POST",//请求方式--%>
         <%--url: "papersController.do?doDel",//发送请求的地址--%>
         <%--data:{id:id},--%>
         ...
         <%--&lt;%&ndash;success: function(data) {&ndash;%&gt;--%>
             <%--&lt;%&ndash;// alert(data.msg);&ndash;%&gt;--%>
              <%--&lt;%&ndash;$.messager.alert('提示',data.msg,'info');&ndash;%&gt;--%>
             <%--&lt;%&ndash;&lt;%&ndash;window.location.href="planController.do?we&id=${plan.id}";&ndash;%&gt;&ndash;%&gt;--%>
